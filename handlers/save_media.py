...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Dot_serials_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("Bots Group", url="https://t.me/Dot_serials_bot"),
                  InlineKeyboardButton("Support Channel", url="https://t.me/dot_serials")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=dot_serials_{str_to_b64(file_er_id)}"
        await editable.edit(
